...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MOVE_MAC]   = LAYOUT_60_ansi(\
     ...
     _______,    MM_UH,    MM_BH,    MAC_CPY,  MAC_PST,  IJ_IMPH,  _______,  IJ_REN,   IJ_IMPL,  IJ_DECL,  IJ_USAG,  KC_RSFT,   \
     _______,    _______,  _______,  _______,  _______,  KC_RGUI,  KC_RALT,  KC_RCTL),
